...
namespace CustomerOrderViewer2 // Note: actual namespace depends on the project name.
{
    
    internal class Program
    {
        private static string _connectionString = @"Data Source=DESKTOP-NHHT57O\MSSQLSERVER1;Initial Catalog=CustomerOrderViewer;Integrated Security=True";
        ...
        private static void DisplayItems()
        {
            ...
            if (items.Any())
            {
                ...
                {
                    Console.WriteLine("{0}: Description is {1}, Price {2}", item.ItemId,item.Description,item.Price);
                }
            }
        }
        ...
        private static void DisplayCustomers()
        {
            ...
            if (customers.Any())
            {
                ...
                {
                    Console.WriteLine("{0}: First Name is {1}, Middle Name {2}, Last Name {3}, Age {4}",
                        customer.CustomerId,
                        customer.FirstName,
        ...
        {
            Console.WriteLine("Enter Costumer Order Id");
